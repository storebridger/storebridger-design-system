...
export const NoControllerDateInput = React.forwardRef<any, SelectProps>(
  (props: SelectProps, ref) => {
    const { label, error, name, control, minDate, ...SelectProps } = props;
    ...
    return (
      <Wrapper>
        <DatePickerInput error={error} onClick={() => setCalendarOpen(true)}>
          <DatePicker
        ...
        {calendarOpen && <ClearDiv onClick={() => setCalendarOpen(false)} />}
      </Wrapper>
    );
  },
);
...
const DatePickerInput = styled.div<{ error: any }>`
